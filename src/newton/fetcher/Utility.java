...
public class Utility {
    ...
    /**
     * Get file(s) from the user, using a file selection dialogue. If cancelled
     * or an invalid name was specified, return null.
     *
    ...
    public static File[] getMultipleFiles(Component parent, String title,
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            ErrorDialog.showError("error-no-name");
    ...
    /**
     * Get a file chooser which can be used to select files or directories, and
     * which knows about BlueJ packages.<p>
     *
     * The caller should use setDialogTitle() to set an appropriate title for
     * the returned chooser.
     *
    ...
    /**
     * Recursively copy all files from one directory to another. If destination
     * is a sub directory of source directory then it returns without copying
     * any files.
     *
     * @return An array contained each source file which was not successfully
     * copied or null if everything went well
     */
    ...
    /**
     * Check whether a given directory contains a file with a given suffix. The
    ...
    /**
     * Find the relative path from some parent directory to a file nested
     * within. For instance, for parent "/a/b" and file "/a/b/c/d/somefile.java"
     * returns "c/d/somefile.java".
     *
